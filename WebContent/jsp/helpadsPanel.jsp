...
<div id="helpPanel"  class="contentbox ui-corner-ll"  style="" > 
	...
	<div>
        <img class="helpImage" alt="" src="<c:url value="/imgs/help/helpAds.png" />"  />
        
		<p class="paragraph" >
		<b class="paragraphStarter" >T</b>his panel displays our advertisements. If you memorize all the advertisements we display every month, you win 9001 life points! Can you guess what Vegeta thinks about this? 
		</p><br />
