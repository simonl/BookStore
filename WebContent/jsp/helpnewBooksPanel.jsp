...
<div id="helpPanel"  class="contentbox ui-corner-ll"  style="" > 
	...
	<div>
        <img class="helpImage" alt="" src="<c:url value="/imgs/help/helpNewBooks.png" />"  />
        
		<p class="paragraph" >
		<b class="paragraphStarter" >T</b>he latest books added to our inventory are shown in this panel. Clicking a book will allow you to see the book's details.
		</p><br />
