...
/**
 * Servlet implementation class TotalSalesDateChooser
 */
public class TotalSalesDateChooser extends ManagerPageServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TotalSalesDateChooser() {
        super();
	...
	public Cont body(Manager token, Database db, Session session,
		...
		return Conts.display("/admin/adminTotalSalesDateChooserPanel.jsp", att);
	}
