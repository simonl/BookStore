...
public final class XML {
	...
	public static final Entry entry(final String key, final Object value) {
		return new Entry(key, value);
	}

	public static final Map<String, Object> attributes(final Entry... pairs) {
	...
	public static final String show(final String indent, final Node node) {
		...
		for(final Map.Entry<String, Object> entry : node.attributes().entrySet()) {
